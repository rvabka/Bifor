    ...
    <section className="relative pt-28 pb-20 overflow-hidden min-h-screen flex flex-col items-center justify-center">
      ...
      >
        <video
          ...
          muted
          playsInline
          className="absolute bottom-0 left-0 h-[24vh] w-auto md:h-[34vh] lg:h-[40vh] drop-shadow-[0_0_25px_rgba(255,178,0,0.2)] safari-hide-video"
        >
        ...
        <video
          ...
          muted
          playsInline
          className="absolute bottom-0 right-0 h-[24vh] w-auto md:h-[34vh] lg:h-[40vh] drop-shadow-[0_0_30px_rgba(255,178,0,0.2)] safari-hide-video"
        >
